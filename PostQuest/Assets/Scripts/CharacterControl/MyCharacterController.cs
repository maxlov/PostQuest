...
namespace Postquest.Controller
{
    ...
    public class MyCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        private bool _diveRequested = false;
        private bool _diveConsumed = false;
                ...
                case CharacterState.Default:
                    {
                        ...
                        if (inputs.CrouchDown)
                        {
                            ...
                            {
                                _isCrouching = true;
                                Motor.SetCapsuleDimensions(0.5f, CrouchedCapsuleHeight, CrouchedCapsuleHeight);
